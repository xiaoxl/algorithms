...
- output:
  ...
  - All output from the final DFS run
    - these data is used to connect the metagraph to the orginal input graph. For example, the first vertex in V_SCC is all vertices with ccnum[v]=1. Therefore the vertices in V_SCC is 1 to k.
  - runtime
    - O(n+m)
